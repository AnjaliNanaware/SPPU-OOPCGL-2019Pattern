...
time in minutes (type float). Write a program that instantiates the book
and tape class, allows user to enter data and displays the data members.
If an exception is caught, replace all the data member values with zero
values.*/
#include<iostream>
#include<string>
using namespace std;
	...
	do {
		...
		switch(choice) {
			...
			case 2: {
				cout<<"\n--------------\n";
				cout<<"Add Tape: \n";
				t[tapeCount].get_data();//t[].get_data()
				tapeCount++;
				break;
			}
			case 3: {
